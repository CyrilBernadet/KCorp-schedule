...
@NgModule({
  declarations: [AppComponent, ListMatchesComponent, LolMatchDetailsComponent, CsgoMatchDetailsComponent, R6sMatchDetailsComponent, RlMatchDetailsComponent, ValorantMatchDetailsComponent],
